            ...
            <div class="x_panel">
              ...
              <div>
                ...
                <form method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  ...
                  <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">StudentID <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 ">
                      <input type="text" id="last-name" name="studentid" required="required" class="form-control">
                    </div>
                  </div>
