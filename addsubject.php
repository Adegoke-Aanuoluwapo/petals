...
if(isset($_POST['AddSubject'])){
	...
	$note = $_POST['note'];
	AddSubject($subject,$note);
}

if(isset($_POST['EditSubject'])){
	$sn = $_POST['EditSubject'];
	$subject = $_POST['subject'];
	$note = $_POST['note'];
	EditSubject($sn,$subject,$note);
}
if(isset($_POST['DeleteSubject'])){
	global $db;
	$subject = $_POST['DeleteSubject'];
    $sql = $db->query("DELETE FROM subjectuser WHERE subject = '$subject' ") or die(mysqli_error($db));
}
?>
...
<?php  if(isset($_POST['EditSub'])){
	$sn = $_POST['EditSub'];
	$sql = $db->query("SELECT * FROM subjectuser WHERE sn= '$sn' ");
									...
									<div class="item form-group">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<button type="submit" name="EditSubject" value="<?= $row['sn'] ?>" class="btn btn-success">Update Subject</button>
											</div>
										</div>
										  ...
										  <tr>
											...
											<td>
											  ...
											  <td>
											    ...
											    <form method="POST">
													<button class="btn btn-success" name="EditSub"  value="<?= $rows['sn'] ?>">UPDATE</button>	
												</form>	
											</td>
										  </tr>
										  <?php  } ?>
