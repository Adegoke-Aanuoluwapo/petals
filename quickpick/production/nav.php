                 ...
                 <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Stock <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="stocklist.php">Stock Details</a></li>
          ...
          <div class="nav_menu">
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  ...
                  <form action="logout.php" method="post"><span >Logout</span>
                <button type="submit" name="Logout"  data-toggle="tooltip" data-placement="top" title="Logout" class="fa fa-sign-out pull-right">
