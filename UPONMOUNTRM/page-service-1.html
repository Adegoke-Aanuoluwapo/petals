...
<html lang="en">
  ...
  <body>
    ...
    <header class="header header-style-4 sticky-bar">
      <div class="container">
        <div class="main-header">
          <div class="header-left">
            ...
            <div class="header-nav">
              <nav class="nav-main-menu d-none d-xl-block">
                <ul class="main-menu">
                  <li class=""><a class="active" href="index-6.html">Home</a>
                   
                  </li>
                  <li class=""><a href="page-about-2.html">About</a>
                   
                  </li>
                  <li class=""><a href="page-service-1.html">Services</a>
                   
                  </li>
                  <li class="has-children"><a href="#">Donations</a>
                    <ul class="sub-menu">
                      <li><a href="page-contact.html"><i class="fi fi-rr-paper-plane"></i>Solar Inverter</a></li>
                      <li><a href="page-signup.html"><i class="fi fi-rr-user-add"></i>Jesus Cares Mission</a></li>
                      <li><a href="page-login.html"><i class="fi fi-rr-fingerprint"></i>Mount Zion Bus</a></li>
          ...
          <div class="header-right">
            <div class="block-signin"><a class="btn btn-black hover-up icon-arrow-right-white" href="page-signup.html">Get Started</a></div>
          </div>
        </div>
      </div>
    </header>
    ...
    <main class="main">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-7 box-banner-left">
                <h1 class="text-display-3 mt-30">Our Services are powerpacked</h1>
                <p class="text-body-lead-large color-gray-500 mt-40 pr-40">Connect with God of All Possibilities <br class="d-lg-block d-none">at our Wonderful Services<br class="d-lg-block d-none"> and your life will not be the same again</p>
                <div class="mt-40"><a class="btn btn-black shape-square icon-arrow-right-white" href="page-about-1.html">Get Started</a><a class="btn btn-link icon-triangle color-gray-900 ml-40" href="page-pricing-1.html">How it works</a></div>
                <div class="row mt-50">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="list-icons">
                      <div class="item-icon none-bd"><span class="icon-left"><img src="assets/imgs/page/about/2/icon-project-done.svg" alt="Agon"></span>
                        <h4 class="text-heading-4"><span class="text-heading-3 color-green-900">+<span class="count">2</span>k</span></h4>
                        <p class="text-body-text color-gray-500">Our Members</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="list-icons">
                      <div class="list-icons">
                        <div class="item-icon none-bd"><span class="icon-left"><img src="assets/imgs/page/about/2/icon-officer.svg" alt="Agon"></span>
                          <h4 class="text-heading-4"><span class="text-heading-3 color-green-900">+<span class="count">18</span></span></h4>
                          <p class="text-body-text color-gray-500">Centers</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-lg-5 d-none d-lg-block">
                <div class="banner-imgs">
                  <div class="block-1 shape-2"><img src="assets/imgs/page/services/1/ZIONALTER.jpg" alt="Agon"></div><img src="assets/imgs/page/services/1/banner.png" alt="Agon">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 col-sm-12 col-12">
              <div class="text-start mb-25"><span class="tag-1 bg-6 color-green-900">Our Mission</span></div>
              <h2 class="text-heading-2 color-gray-900 mb-50">We&apos;re always taking the love of God <br class="d-lg-block d-none"> to the captives of the devil with raw apostolic manifestations</h2>
            </div>
          </div>
        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="list-icons">
                <div class="item-icon none-bd"><span class="icon-left"><img src="assets/imgs/page/services/1/icon-support.svg" alt="Agon"></span>
                  <h4 class="text-heading-6">1st Sunday of the Month</h4>
                  <p class="text-body-text color-gray-600 mt-15">Prophetic And Miracle Service. <em>Time: 9:00AM</em></p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="list-icons">
                <div class="item-icon none-bd"><span class="icon-left"><img src="assets/imgs/page/services/1/icon-web.svg" alt="Agon"></span>
                  <h4 class="text-heading-6">1st Monday of the Month</h4>
                  <p class="text-body-text color-gray-600 mt-15">Good Morning Holy Spirit <i>Time: 6:00AM</i></p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="list-icons">
                <div class="item-icon none-bd"><span class="icon-left"><img src="assets/imgs/page/services/1/icon-business.svg" alt="Agon"></span>
                  <h4 class="text-heading-6">1st Wednesday</h4>
                  <p class="text-body-text color-gray-500 mt-15">Jacob at Jabbok <em>Time: 10:00PM</em></p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="list-icons">
                <div class="item-icon none-bd"><span class="icon-left"><img src="assets/imgs/page/services/1/icon-product.svg" alt="Agon"></span>
                  <h4 class="text-heading-6">Every Tuesday</h4>
                  <p class="text-body-text color-gray-500 mt-15">Systematic and Expository Bible Study <br><em>
                    Time: 6:00PM
                  </em></p>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="list-icons">
                <div class="item-icon none-bd"><span class="icon-left"><img src="assets/imgs/page/services/1/icon-share.svg" alt="Agon"></span>
                  <h4 class="text-heading-6">Every Friday </h4>
                  <p class="text-body-text color-gray-500 mt-15">Power Night <br><em>Time: 5:00AM</em>.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="list-icons">
                <div class="item-icon none-bd"><span class="icon-left"><img src="assets/imgs/page/services/1/icon-build.svg" alt="Agon"></span>
                  <h4 class="text-heading-6">Every Last Friday</h4>
                  <p class="text-body-text color-gray-500 mt-15">Deliverance Night.<br><em>Time: 10:00PM</em></p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="list-icons">
                <div class="item-icon none-bd"><span class="icon-left"><img src="assets/imgs/page/services/1/icon-team.svg" alt="Agon"></span>
                  <h4 class="text-heading-6">Support Engineer</h4>
                  <p class="text-body-text color-gray-500 mt-15">We commit to original work of the highest standard and giving credit where it&apos;s due.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="section-box mt-70">
        <div class="container mt-50">
          <h3 class="text-heading-1 text-center mb-10">Choose The Best Plan<br class="d-lg-block d-none"> That&rsquo;s For You</h3>
        </div>
        <div class="container mt-20">
                ...
                <div class="row">
                  <div class="col-xl-3 col-lg-6 col-md-6 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                    <div class="box-pricing-item hover-up">
                      <div class="box-info-price"><span class="text-heading-3 for-month display-month">$35</span><span class="text-heading-3 for-year">$420</span><span class="text-month for-month text-body-small color-gray-400">/month</span><span class="text-month for-year text-body-small color-gray-400">/year</span></div>
                  ...
                  <div class="col-xl-3 col-lg-6 col-md-6 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                    <div class="box-pricing-item active hover-up">
                      <div class="box-info-price"><span class="text-heading-3 for-month display-month">$89</span><span class="text-heading-3 for-year">$1068</span><span class="text-month for-month text-body-small color-gray-400">/month</span><span class="text-month for-year text-body-small color-gray-400">/year</span></div>
                      <div class="line-bd-bottom">
                  ...
                  <div class="col-xl-3 col-lg-6 col-md-6 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                    <div class="box-pricing-item hover-up">
                      <div class="box-info-price"><span class="text-heading-3 for-month display-month">$125</span><span class="text-heading-3 for-year">$1500</span><span class="text-month for-month text-body-small color-gray-400">/month</span><span class="text-month for-year text-body-small color-gray-400">/year</span></div>
                      <div class="line-bd-bottom">
                        <h4 class="text-heading-5 mb-15">Premium</h4>
                        <p class="text-body-small color-gray-400">Avvanced features for pros who need more customization.</p>
                      </div>
                      <ul class="list-package-feature">
                        <li>Unlimited updates</li>
                        <li>Custom designs &amp; features</li>
                  ...
                  <div class="col-xl-3 col-lg-6 col-md-6 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                    <div class="box-pricing-item hover-up">
                      <div class="box-info-price"><span class="text-heading-3 for-month display-month">$199</span><span class="text-heading-3 for-year">$2388</span><span class="text-month for-month text-body-small color-gray-400">/month</span><span class="text-month for-year text-body-small color-gray-400">/year</span></div>
                      <div class="line-bd-bottom">
