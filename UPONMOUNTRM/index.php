      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
        <a href="" class="navbar-brand p-0">
          <h1 class="text-primary m-0">
            <img src="img/UPMZRM.jpg" alt="Logo">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <!-- <a href="/payment.php" class="btn btn-primary py-2 px-4">Donations</a> -->
        </div>
      </nav>
          ...
          <div class="row align-items-center g-5">
            <div class="col-lg-6 text-center text-lg-start">
              <h1 class="display-3 text-white animated slideInLeft">
                Come <br />And Taste Christ
              </h1>
              <p class="text-white animated slideInLeft mb-4 pb-2">
                The church stands on holiness and apostolic manifestation
              </p>
          ...
          <div class="col-lg-6">
            <div class="row g-3">
              <div class="col-6 text-start">
                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.1s" src="img/jcs1.jpg" />
              </div>
              <div class="col-6 text-start">
                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.3s" src="img/jcs2.jpg" style="margin-top: 25%" />
              </div>
              <div class="col-6 text-end">
                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="img/jcs3.jpg" />
              </div>
              <div class="col-6 text-end">
                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.7s" src="img/jcs4.jpg" />
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            ...
            <h1 class="mb-4">
              Welcome to
              <i class="fa fa-utensils text-primary me-2"></i>Upon Mount Zion
              Revival and Bible Church
            </h1>
            <p class="mb-4">
              Mott: Deliverance, Holiness and Great Possession
              <i>(Obad 1:17)</i>.
            </p>
            <p class="mb-4">
              We are saddled with the responsibilities of the great command from our Saviour, We spread the love of Christ to others in practical demonstration of apostolic power
            </p>
      ...
      <div class="row g-0">
        ...
        <div class="col-md-6 bg-dark d-flex align-items-center">
          <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
            ...
            <h1 class="text-white mb-4">Kindly fill the form</h1>
            <form>
              <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    ...
                    <label for="select1">Type of Service</label>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-floating">
    ...
    <div class="container-xxl pt-5 pb-3">
      <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
          ...
          <h1 class="mb-5">Our Annointed Men of God</h1>
        </div>
        <div class="row g-4">
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="team-item text-center rounded overflow-hidden">
              <div class="rounded-circle overflow-hidden m-4">
                <img class="img-fluid" src="img/PstIgbekele2.jpg" alt="" />
              </div>
              <h5 class="mb-0">Pastor Dr. Adebola Igbekele</h5>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
      <div class="container">
        <div class="text-center">
          ...
          <h1 class="mb-5">Tip of an Iceberge Testimony!!!</h1>
        </div>
      ...
      <div class="container py-5">
        <div class="row g-5">
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <p class="mb-2">
              <i class="fa fa-map-marker-alt me-3"></i>No 1, Aaye Junction,
              Ijare Road Ondo State
            </p>
            <p class="mb-2">
              <i class="fa fa-phone-alt me-3"></i>+2348064464790
            </p>
            <p class="mb-2">
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <p>We would be glad to be of help to you.</p>
        ...
        <div class="copyright">
          <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
              &copy; <a class="border-bottom" href="#">UponMountZionRM</a>,
              All Right Reserved.

              <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
              Designed By
              <a class="border-bottom" href="https://htmlcodex.com">Rehoboth Tech</a>
            </div>
