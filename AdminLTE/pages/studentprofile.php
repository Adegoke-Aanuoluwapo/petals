...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="modal-body">
                            <form id="make_pay" class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <select name="fee_cat" id="fee_cat" class="form-control select2bs4 select2-hidden-accessible" data-select2-id="fee_cat" tabindex="-1" aria-hidden="true">
                                        <option disabled="" selected="" data-select2-id="3">Select Fee Category</option>
   ...
   <script>
    $(function() {
     $.ajaxSetup({
      headers: {
       'Authorization': `Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..Tc_5P7pDzkYzTSsKfcjYWecJbCQuyGe_kimQMvQwsij0Qt9AVaxhbbiv2-K7BhnaSl1rLPPkO9k9a9_QQkM_gtxRXRIk7YGwAAVFsuofIDKtvBIY2pkwfmED5QKkVvj_s1eYw4vbBUaoJ6p0uJcx0mNV8tQ_8O4eer9sYO1XwLe7_GXVjdKwBHal5X_gnrkg3jTSTlnPed0vTnU407TRQKbZ5yDNb2Pra_L8fvk8OYBsR_A0H-EjNKeHubuinPS8R7NeV0hL3NyDmYtgZL8J6l8xGvBRWwXmDYhGVURRgqy6_QvyafE0HrqI-ow8oRngUm3whdZHy-fwZDPCY1ytofS152Z0H3_K7bx-_ESF8dsG67HAD3LdJ6v0tR9FOXDjQ1nM32g2Ei-D9gM3tcTOnAE7vcuAAuYe9fNEGHqJ441WuhsLd55qojmOUSsNIhBv36WbPb51_yiE9guwiVfMzOjhHscmmePKfJTvQDnBSXjO_5JDyC0CByRp6d9u3-jdv8FtlxJ4Z_A1SogGn7-j9Vmg0coBYvYd84ay6RYAFNMbXgx017mEzKFOq1d6FGgbH5fr85GCqIziiEbtM80-pCoFjMm_LJJ5z9VqRqNYN0AMvN6qBfdS04jbp3ZuWzZfdd2avJDL3-ierwlcZm4pXh5o10cyfY7M7TcX-6TYkQI`
      }
     });
     ...
     $('body').on('click', '.auth_det', function(e) {
      ...
      if (!username || !pass) {
       littleAlert('The username and password field is required', 1);
       return;
      }
      $.ajax({
       method: 'post',
     ...
     $('body').on('click', '.basic_info', function(e) {
      ...
      if (!guard || !surname || !firstname || !gender) {
       littleAlert('Pls fill out the required fields');
       return;
      }
     ...
     $('body').on('click', '.make_pay', function(e) {
      ...
      if (!confirm(`Are you sure you want to make payment of ${moneyFormat(amt)} ? payment cannot be altered once submited.`)) {
       return;
      }
      $.ajax({
       method: 'post',
