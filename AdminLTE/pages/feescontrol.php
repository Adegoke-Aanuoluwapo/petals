...
<?php include("nav.php") ?>
  ...
  <div class="content-wrapper">
   ...
   <!-- ChartJS -->
   <script src="https://portal.schoolpetal.com/assets/plugins/chart.js/Chart.min.js"></script>
   <!-- AdminLTE App -->
   <script src="https://portal.schoolpetal.com/assets/js/adminlte.min.js"></script>
   <!-- AdminLTE for demo purposes -->
   <script src="https://portal.schoolpetal.com/assets/js/demo.js"></script>
