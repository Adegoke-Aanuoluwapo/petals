...
class Children
{
  ...
  function EditTeachers($tId, $name, $district, $phone, $role, $grdistrict, $region, $password)
  {
    global $con;
    // $id = $_GET['id'];
    $sql = ("UPDATE teachers SET name='$name', district='$district', phone='$phone', role='$role', grdistrict='$grdistrict', region='$region', password='$password' WHERE id = '$tId'");
    if ($sql) {
