                                                        ...
                                                        <div class="panel-body">
                                                                ...
                                                                <form method="post">
                                                                        ...
                                                                        <p>
                                                                                ...
                                                                                <button type="button" onclick="editChild()" class="btn btn-warning" name="editchild" style="width:100%">REGISTER CHILD</button>
                                                                ...
                                                                <script>
                                                                        ...
                                                                        function editChild() {
                                                                                ...
                                                                                $.ajax({
                                                                                        type:'get',
                                                                                        url:'myclass.php?cId='+c+'&surname='+surname+'&firstname='+firstname+'&othername='+othername+'&familyname='+familyname+'&sex='+sex+'&birthdate='+birthdate+'&address='+address+'&addressarea='+addressarea+'&school='+school+'&class='+clas+'&type=editchild'
                                                                                }).done(function(data){
                                                                                        alert(data);
                                                                                })
